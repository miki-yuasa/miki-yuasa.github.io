    ...
    return (
        <div id='research'
            ...
            <div class='sectionBody'>
                ...
                <ol>
                    <li>Development and implementation of a CFD software solver library (OpenFOAM) for dynamic mesh generation for seal whiskers.</li>
                    <li>Development of a MATLAB<sup>®</sup> library of Schwartz-Christoffel conformal mesh-generation method for 2D geometry.</li>
                </ol>
